...
<Box p={['20px', '20px 40px']}>
    ...
    <p>
      If you are located outside <span className="country-name">Vietnam</span> and
      choose to provide information to us, please note that we transfer the data,
      including Personal Data, to <span className="country-name">Vietnam</span>{" "}
    ...
    <p>
      <span className="company-name">Geek Hub Solution JSC</span> will take all
    ...
    <p>
      <b>
        0.3. To stop selling your personal information. You are the only owner of
