...
return (
    ...
    <p>
      <span className="num">4</span>. <b>Contests, Sweepstakes and Promotions</b>
    </p>
    <p>
    ...
    <div id="subscriptions">
      ...
      <p>
        ...
        <span className="company-name">Geek Hub Solution JSC</span> cancels it.
        You may cancel your Subscription renewal either through your online
        account management page or by contacting{" "}
      ...
      <p>
        ...
        <span className="company-name">Geek Hub Solution JSC</span> with accurate
        and complete billing information that may include but not limited to full
        ...
        <span className="company-name">Geek Hub Solution JSC</span> to charge all
        Subscription fees incurred through your account to any such payment
        instruments.
      </p>
      <p>
        Should automatic billing fail to occur for any reason,{" "}
        <span className="company-name">Geek Hub Solution JSC</span> reserves the
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> may, at its
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span>, in its sole
        discretion and at any time, may modify Subscription fees for the
        Subscriptions. Any Subscription fee change will become effective at the
        end of the then-current Billing Cycle.
      </p>
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> will provide
        you with a reasonable prior notice of any change in Subscription fees to
    ...
    <div id="tc-content">
      ...
      <p>
        <span className="company-name">Geek Hub Solution JSC</span> has the right
        but not the obligation to monitor and edit all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property of{" "}
        <span className="company-name">Geek Hub Solution JSC</span> or used with
    ...
    <p>
      ...
      <span className="country" /> and foreign countries. Our trademarks may not
      be used in connection with any product or service without the prior written
      consent of <span className="company-name">Geek Hub Solution JSC</span>.
    </p>
    <p>
    ...
    <p>
      ...
      <span className="email">hello@upme.cloud</span>, with the subject line:
    ...
    <p>
      ...
      <span className="email">hello@upme.cloud</span> or via third party sites and
      ...
      Service (“Feedback”). You acknowledge and agree that: (i) you shall not
    ...
    <p>
      <span className="company-name">Geek Hub Solution JSC</span> has no control
    ...
    <p>
      ...
      <span className="country-name">Vietnam</span>, which governing law applies
